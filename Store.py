...
class store:
    ...
    def createItem(self):
        ...
        self.items.append(item.item("Resource/item/sword.png", "Sword", 200, 350 - 75, 'Rare', 0, 600))
        self.items.append(item.item("Resource/item/shield.png", "Shield", 200, 350 - 150, 'Normal', 0, 100))
